let vehicles = [];
        ...
        document.getElementById("vehicleForm").addEventListener("submit", function(e) {
            ...
            const marca = document.getElementById("brand").value.toUpperCase()
            const modelo = document.getElementById("model").value.toUpperCase()
            ...
            if (selectedCustomer){
                ...
                const nombre = document.getElementById("customerName").value.toUpperCase()
